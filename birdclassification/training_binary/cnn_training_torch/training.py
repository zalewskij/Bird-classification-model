...
BIRD_RECORDINGS_DIR = Path('/mnt/d/recordings_30') # Path("D:\\JAcek\\recordings_30")
NOT_BIRD_RECORDINGS_DIR = Path('')
...
for epoch in range(EPOCHS):
    ...
    validation_precision_score = calculate_metric(cnn, val_dl,
